...
public static class ViewModelExtensions
{
    ...
    public static void Bind<T, R>(this T viewModel, System.Linq.Expressions.Expression<Func<T, R>> outExpr, Action b) where T : INotifyPropertyChanged
    {
    ...
    public static void Bind<T, R>(this T viewModel, System.Linq.Expressions.Expression<Func<T, R>> outExpr, Action<R> b) where T : INotifyPropertyChanged
    {
        var expr = (System.Linq.Expressions.MemberExpression) outExpr.Body;
        var prop = (System.Reflection.PropertyInfo) expr.Member;
        var name = prop.Name;
